fragen = [
    ...
    },
    {
        ...
        "antworten": [
            ...
            {"text": "Du läufst zielstrebig den langen, heruntergekommenen Tunnel entlang. Um etwas zu sehen, fragst du die Glühwürmchen nach Hilfe. Gerade als sie mit ihrem Tanz beginnt, siehst du, wie sich hinter dir eine geheime Tür öffnet. Von drinnen hörst du die Gummibärenbande und stimmst freudig in ihr Lied mit ein.", "kategorie": "Demeter"},
            ...
            {"text": "Du merkst den Druck auf deiner Brust und dir schwinden fast die Sinne. Du wirst immer höher und höher getragen. Im Rückspiegel siehst du die Welt immer kleiner und kleiner werden. Du spürst erst jetzt, wie bedeutend dein Leben sein wird, während du zu neuen Welten aufbrichst. Durch die Lautsprecher erklingt der Gesang: „Ooh yeah, yeah, I’m your basic average girl and I’m here to save the world", "kategorie": "Apollo"},
        ]
    },
    {
